...
#define RZF_SYSC_BASE_ADDR		0x11020000
#define RZF_SYSC_SYS_SLVACCCTL0		0x100
#define RZF_SYSC_SYS_SLVACCCTL1		0x104

#define RZF_GPV_AX45MP_MEM_ADDR		0x10642000
#define RZF_GPV_AX45MP_MEM_FN_MOD2	0x24
#define RZF_GPV_AX45MP_MEM_READ_QOS	0x100
#define RZF_GPV_AX45MP_MEM_WRITE_QOS	0x104
